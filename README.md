...
The **Virtual Money Counter** is a program that detects coins in a video using the Hough Transform method. It processes
video frames, identifies circular objects (coins), and displays the results. The program is built using C++ and OpenCV
for image processing and video capture.
